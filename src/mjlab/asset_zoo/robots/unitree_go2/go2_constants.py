...
# ---------------------------------------------------------------------------
# Follow style in src/mjlab/asset_zoo/robots/unitree_go2/go2_constants.py
# Write a Go2 module
...
KNEE_ACTUATOR = ElectricActuator(
  ...
  velocity_limit=15.70,      # TODO: Insert max joint velocity (rad/s).
  effort_limit=45.43,        # TODO: Insert torque limit (Nm).
)
